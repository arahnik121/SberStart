...
public class MainClass {
    public static void main(String[] args) {
        SQLStorage storage = Config.initDatabase();
        ...
        Account account2 = new Account(UUID.fromString("12314123-0886-11eb-adc1-0242ac120002"), 123532563, client1.getId());
        Card card1 = new Card(UUID.fromString("9b2661d4-0886-11eb-adc1-0242ac120002"), 123123, UUID.fromString("14aa7075-7077-49d6-a621-9d91fa65ef79"), BigDecimal.valueOf(120));
        ...
        card1.changeBalance(storage,BigDecimal.valueOf(300));
        System.out.println(storage.getCard(UUID.fromString("9b2661d4-0886-11eb-adc1-0242ac120002")).getBalance());
